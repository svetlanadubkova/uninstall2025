...
export default function UninstallWizard() {
  ...
  const renderContent = () => {
    switch(screen) {
      ...
      case "WIZARD_C": return <WizardStep step="step 3 of 14" title="scanning for corrupted narratives..." content="whose story are you living? theirs or yours? you know yourself and what you need best; where you're going. TRUST YOURSELF." onNext={() => setScreen("WIZARD_D")} useTyping={true} userName={userName} />;
      ...
      case "WIZARD_H": return <WizardStep step="step 8 of 14" title="removing attachment to timelines and outcomes..." content={`you speedran through love and heartbreak and growth and that's GOOD actually. you didn't run. you stayed present, open, vulnerable, and earnest even when it was hard. tomorrow is a beautiful thing. LFG :-)`} onNext={() => setScreen("WIZARD_I")} userName={userName} />;
